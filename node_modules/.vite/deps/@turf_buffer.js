...
// node_modules/@turf/meta/node_modules/@turf/helpers/dist/es/index.js
...
// node_modules/@turf/center/node_modules/@turf/helpers/dist/es/index.js
...
function center(geojson, options) {
  ...
  var x = (ext[0] + ext[2]) / 2;
  var y = (ext[1] + ext[3]) / 2;
  return point2([x, y], options.properties, options);
}
...
var parse$1 = {
  ...
  multipoint: function multipoint2(str) {
    ...
    for (var i = 0, len = points.length; i < len; ++i) {
      point5 = points[i].replace(regExes.trimParens, "$1");
      components.push(parse$1.point.apply(this$1, [point5]));
    }
...
var Point = function(Geometry$$1) {
  ...
  Point2.prototype.compareToSameClass = function compareToSameClass() {
    if (arguments.length === 1) {
      ...
      var comp = arguments[1];
      var point5 = other$1;
      return comp.compare(this._coordinates, point5._coordinates);
    }
  };
...
GeometryFactory.prototype.createMultiPoint = function createMultiPoint() {
  ...
  if (arguments.length === 0) {
    ...
    if (arguments[0] instanceof Array) {
      var point5 = arguments[0];
      return new MultiPoint(point5, this);
    } else if (arguments[0] instanceof Array) {
      var coordinates = arguments[0];
      return this.createMultiPoint(coordinates !== null ? this.getCoordinateSequenceFactory().create(coordinates) : null);
    } else if (hasInterface(arguments[0], CoordinateSequence)) {
...
var parse2 = {
  ...
  Feature: function(obj) {
    ...
    if (obj.geometry) {
      ...
      feature4.geometry = this.read(obj.geometry);
    }
    if (obj.bbox) {
      feature4.bbox = parse2.bbox.apply(this, [obj.bbox]);
    }
    return feature4;
  },
  /**
...
var extract2 = {
   ...
   */
  Point: function(point5) {
    var array2 = extract2.coordinate.apply(this, [point5.getCoordinate()]);
    return {
      type: "Point",
      coordinates: array2
    };
  ...
  MultiPoint: function(multipoint3) {
    ...
    for (var i = 0; i < multipoint3._geometries.length; ++i) {
      var point5 = multipoint3._geometries[i];
      var geoJson = extract2.Point.apply(this$1, [point5]);
...
function polygon_default(segments, compareIntersection2, startInside, interpolate, stream) {
  ...
  while (1) {
    ...
    do {
      ...
      if (current.e) {
        if (isSubject) {
          for (i = 0, n = points.length; i < n; ++i) stream.point((point5 = points[i])[0], point5[1]);
        } else {
        ...
        if (isSubject) {
          points = current.p.z;
          for (i = points.length - 1; i >= 0; --i) stream.point((point5 = points[i])[0], point5[1]);
        } else {
  ...
  return function(stream) {
    ...
    function polygonInside() {
      ...
      for (var i = 0, n = polygon3.length; i < n; ++i) {
        for (var ring2 = polygon3[i], j = 1, m = ring2.length, point6 = ring2[0], a0, a1, b0 = point6[0], b1 = point6[1]; j < m; ++j) {
    ...
    function lineStart() {
      ...
      if (polygon3) polygon3.push(ring = []);
      first = true;
      v_ = false;
      x_ = y_ = NaN;
    }
...
function polygonContains_default(polygon3, point5) {
  var lambda = point5[0], phi = point5[1], normal = [sin(lambda), -cos(lambda), 0], angle3 = 0, winding = 0;
  sum.reset();
  for (var i = 0, n = polygon3.length; i < n; ++i) {
    if (!(m = (ring = polygon3[i]).length)) continue;
...
function clip_default(pointVisible, clipLine, interpolate, start) {
  return function(rotate, sink) {
    ...
    function point5(lambda, phi) {
      var point6 = rotate(lambda, phi);
      if (pointVisible(lambda = point6[0], phi = point6[1])) sink.point(lambda, phi);
    }
    ...
    function ringEnd() {
      ...
      ringSink.lineEnd();
      var clean = ringSink.clean(), ringSegments = ringBuffer.result(), i, n = ringSegments.length, m, segment, point6;
      ring.pop();
      polygon3.push(ring);
      ring = null;
      if (!n) return;
      if (clean & 1) {
        ...
        if ((m = segment.length - 1) > 0) {
          if (!polygonStarted) sink.polygonStart(), polygonStarted = true;
          sink.lineStart();
          for (i = 0; i < m; ++i) sink.point((point6 = segment[i])[0], point6[1]);
          sink.lineEnd();
        }
        return;
      }
  ...
  return {
    ...
    point: function(lambda1, phi1) {
      ...
      if (abs2(delta - pi) < epsilon) {
        ...
        if (abs2(lambda0 - sign0) < epsilon) lambda0 -= sign0 * epsilon;
        if (abs2(lambda1 - sign1) < epsilon) lambda1 -= sign1 * epsilon;
...
function projectionMutator(projectAt) {
  ...
  function projection2(point5) {
    ...
    return [point5[0] * k + dx, dy - point5[1] * k];
  }
  function invert(point5) {
    point5 = projectRotate.invert((point5[0] - dx) / k, (dy - point5[1]) / k);
...
// node_modules/@turf/buffer/node_modules/@turf/helpers/dist/es/index.js
var earthRadius3 = 63710088e-1;
var factors3 = {
  centimeters: earthRadius3 * 100,
  centimetres: earthRadius3 * 100,
  degrees: earthRadius3 / 111325,
  feet: earthRadius3 * 3.28084,
  inches: earthRadius3 * 39.37,
  kilometers: earthRadius3 / 1e3,
  kilometres: earthRadius3 / 1e3,
  meters: earthRadius3,
  metres: earthRadius3,
  miles: earthRadius3 / 1609.344,
  millimeters: earthRadius3 * 1e3,
  millimetres: earthRadius3 * 1e3,
  nauticalmiles: earthRadius3 / 1852,
  radians: 1,
  yards: earthRadius3 * 1.0936
};
var unitsFactors3 = {
  centimeters: 100,
  centimetres: 100,
...
function radiansToLength(radians2, units) {
  ...
  var factor = factors3[units];
  if (!factor) {
    throw new Error(units + " units is invalid");
  }
  return radians2 * factor;
}
function lengthToRadians(distance10, units) {
  if (units === void 0) {
    units = "kilometers";
  }
  var factor = factors3[units];
...
function buffer2(geojson, radius, options) {
  ...
  switch (geojson.type) {
    ...
    case "FeatureCollection":
      featureEach(geojson, function(feature4) {
        var multiBuffered = bufferFeature(feature4, radius, units, steps);
        if (multiBuffered) {
...
function bufferFeature(geojson, radius, units, steps) {
  ...
  return feature3(result, properties);
}
...
function defineProjection(geojson) {
  ...
  return azimuthalEquidistant_default().rotate(rotation).scale(earthRadius3);
}
